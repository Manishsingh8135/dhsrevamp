...
const HeroImg = () => {
    return (
        <div className="flex flex-col h-screen p-6 mt-8">
            ...
            <div className="w-full h-3/5 grid grid-cols-2 gap-4">
                <div className="flex items-center justify-center">
                    <Image 
                        ...
                        width={500} 
                        height={400} 
                        className="object-cover w-full h-full rounded-lg hover:cursor-pointer hover:scale-105 transition-transform duration-300 shadow-lg" 
                    />
                </div>
                <div className="flex items-center justify-center">
                    <Image 
