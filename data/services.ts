...
export interface ServiceData {
  ...
  benefits: string[];
  comparisonData: { feature: string; us: string; others: string }[];
}
...
export const kitchenData: ServiceData = {
  ...
  heroImage: "/assets/kitchen/kitchen2.jpg",
  features: [
  ...
  gallery: [
    { src: "/images/kitchen-1.jpg", alt: "Modern kitchen with island" },
    { src: "/images/kitchen-2.jpg", alt: "Rustic kitchen design" },
    { src: "/images/kitchen-3.jpg", alt: "Minimalist white kitchen" },
    { src: "/images/kitchen-4.jpg", alt: "Luxury kitchen with marble countertops" },
    { src: "/images/kitchen-5.jpg", alt: "Contemporary kitchen with wood accents" },
    { src: "/images/kitchen-6.jpg", alt: "Open concept kitchen and dining area" }
  ],
  testimonials: [
...
// Add similar data structures for bathroom, bedroom, etc.